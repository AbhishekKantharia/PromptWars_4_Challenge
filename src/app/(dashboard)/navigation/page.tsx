...
export default function NavigationPage() {
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-fifa-white">Intelligent Navigation</h1>
        <p className="text-sm text-fifa-gray mt-1">Find your way with AI-powered, crowd-aware, accessible routing</p>
      </div>
      <VenueMap />
    </div>
  );
